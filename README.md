...
`assets/sample-preview.mp4` 是一条正式发布成片《预制菜明示》的前 60 秒（960p 压缩版，原片 10 分 11 秒）。

<img src="assets/sample-preview.jpg" width="640" alt="新闻报道原片做主体，右侧花字给时间与人物，右上角固定品牌字标，底部整句字幕，左下角来源标注">
